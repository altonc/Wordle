...
int main(int argc, char* argv[]){
    ...
    int ptr1 = stoi(argv[1]);
    std::string ptr2 = (argv[2]);
    std::string ptr3 = argv[3];

    int *ptr = &ptr1;
    std::string *inptr = &ptr2;
    std::string *alwptr = &ptr3;
    ...
    while (go){
        ...
        if (choice == 1 || choice == 2 || choice == 3 || choice == 4 || choice == 5){
            if (choice == 1){
                ...
                counter++;
                //test mytest;
                //std::cout<<*ptr<<*inptr<<*alwptr;
                play_wordle(*ptr, *inptr, *alwptr);
            }
            else if (choice ==2){
                howtoplay();
            }
                ...
                key_stop.close();
                std::fstream corner;
                corner.open("key.txt", std::ios::out);
                if (corner.is_open()){
                    corner<<"";
                    corner<<"waiting";
                }
